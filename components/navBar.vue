                    ...
                    <div class="relative ml-3">
                        <div>
                            <button type="button" @click="toggleDropdown"
                                ...
                                <div class="h-8 w-8 rounded-full bg-gray-400 flex items-center justify-center">{{ unameFW }}
                                </div>
                        ...
                        <div class="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none "
                            :class="{ 'transition ease-out duration-100 transform opacity-100 scale-100': isDropdownOpen, 'transition ease-in duration-75 transform opacity-0 scale-95': !isDropdownOpen }"
